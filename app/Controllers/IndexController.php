...
class IndexController extends BaseController
{
    ...
    {
//		测试Redis
//		$redis = \Mphp\Cache::getInstance('redis', ['database'=>4]);
...
//		Mphp\Libraries\Log::getInstance(LOG_PATH)->log('app_', print_r(debug_backtrace(),1));
//		Mphp\Libraries\Log::getInstance(LOG_PATH)->log('app_', print_r(get_included_files(),1));
...
//		api_log(STAT, 10001, 'error message!!');
    ...
    {
        $data = (new \Mphp\Libraries\Curl())->get('http://www.sina.com');
        var_dump($data);
    }
}